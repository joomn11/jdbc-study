package com.hello.jdbc1.exception.translator;
...
public class SpringExceptionTranslatorTest {
    ...
    void sqlExceptionErrorCode() {
        ...
        try {
            ...
            int errorCode = e.getErrorCode(); // DBMS 마다 코드가 다름 , DB를 변경하면 모든 코드 변경 필요
    ...
    void exceptionTranslator() {
        ...
        try {
            ...
            DataAccessException resultEx = exTranslator.translate("translator test", sql, e);
